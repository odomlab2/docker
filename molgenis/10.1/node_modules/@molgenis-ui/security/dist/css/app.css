/*!
 * package-name: @molgenis-ui/security
 * package-version: 0.4.4
 * build-date: Thu, 11 Mar 2021 09:51:08 GMT
 */.slide-enter-active,.slide-leave-active{transition:transform .5s ease-in-out}.slide-enter,.slide-leave-to{transform:translateY(-100%)}.slide-enter-to,.slide-leave{transform:translateY(0)}
