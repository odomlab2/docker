/*!
 * package-name: @molgenis-ui/navigator
 * package-version: 0.2.2
 * build-date: Mon, 08 Mar 2021 14:18:55 GMT
 */
@media (min-width:1200px){.container{width:1199px}}.job-alerts{left:1rem;right:1rem;bottom:60px}@media (min-width:1200px){.job-alerts{left:75%}}.navigator-search{margin-bottom:1rem}.navigator-actions{margin-bottom:2rem}.btn.disabled{cursor:not-allowed!important}.btn-tooltip-wrapper{display:inline;padding:.375rem 0}.fa-disabled{opacity:.6}.breadcrumb[data-v-56b5cec5]{background-color:transparent}.button-last[data-v-107ebe9f]{margin-right:1rem}.table-container{width:100%;height:70vh;overflow-y:auto}.invisible{visibility:hidden}.compact{width:1px;white-space:nowrap}
/*!
